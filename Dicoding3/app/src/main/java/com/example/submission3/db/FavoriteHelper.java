...
import static com.example.submission3.db.DatabaseContract.NoteColumns.COUNT;
...
import static com.example.submission3.db.DatabaseContract.NoteColumns.LANGUAGE;
...
public class FavoriteHelper {
    ...
    public ArrayList<Movie> getAllFavorites() {
        ...
        if (cursor.getCount() > 0) {
            do {
                ...
                movie.setCount(cursor.getString(cursor.getColumnIndexOrThrow(COUNT)));
    ...
    public ArrayList<TVShow> getAllFavorites2() {
        ...
        if (cursor.getCount() > 0) {
            do {
                ...
                tvShow.setCount(cursor.getString(cursor.getColumnIndexOrThrow(COUNT)));
    ...
    public long insertFavorite2(TVShow tvShow) {
        ...
        args.put(COUNT, tvShow.getCount());
